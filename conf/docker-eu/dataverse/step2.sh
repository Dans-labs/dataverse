...
echo $wdir
cd $wdir
if [ ! -e $wdir/dataverse/dv/deps/dvinstall.zip ]; then
	wget https://github.com/IQSS/dataverse/releases/download/v4.8.5/dvinstall.zip -O $wdir/dataverse/dv/deps/dvinstall.zip
fi

if [ ! -e $wdir/dataverse/dv/deps/dataverse.war ]; then
 	wget https://github.com/IQSS/dataverse/releases/download/v4.8.5/dataverse-4.8.5.war -O $wdir/dataverse/dv/deps/dataverse.war
fi
